...
const BLOG = {
  ...
  NEXT_REVALIDATE_SECOND: process.env.NEXT_PUBLIC_REVALIDATE_SECOND || 5, // 【默认修改成5】更新内容缓存间隔 单位(秒)；即每个页面有5秒的纯静态期、此期间无论多少次访问都不会抓取notion数据；调大该值有助于节省Vercel资源、同时提升访问速率，但也会使文章更新有延迟。
  ...
  GREETING_WORDS:
    ...
    'Hi，我是做楼梯配件生产的,做这个网站主要是为了方便各地经销商和江浙沪周边的朋友沟通交流🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '领凡', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '领凡楼梯配件加工厂', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.leadman.shop', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '领凡,楼梯,领凡楼梯,楼梯定制,楼梯厂,楼梯安装,别墅楼梯,楼梯设计', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'zh_fan@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  //   ********挂件组件相关********
  // ----> 评论互动 可同时开启多个支持 WALINE VALINE  CUSDIS UTTERRANCES GITALK
  ...
  COMMENT_UTTERRANCES_REPO:
    process.env.NEXT_PUBLIC_COMMENT_UTTERRANCES_REPO || 'zhangfan603/NotionNext', // 你的代码仓库名， 例如我是 'tangly1024/NotionNext'； 更多文档参考 https://utteranc.es/

  // giscus @see https://giscus.app/
  COMMENT_GISCUS_REPO: process.env.NEXT_PUBLIC_COMMENT_GISCUS_REPO || 'zhangfan603/NotionNext', // 你的Github仓库名 e.g 'tangly1024/NotionNext'
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'Leadman', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'Leadman', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Leadman Stair', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '楼梯配件厂', // 站点描述，被notion中的页面描述覆盖
