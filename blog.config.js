...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Leadman', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '楼梯加工厂', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://leadman.shop', // 网站地址
